...
conv_mode = "lstp"
# model_path = "ckpts/LSTP-Chat/LSTP-7B.ckpt"  # 原始
model_path = "/root/LSTP-Chat/LSTP-7B.ckpt"
# model_base = 'ckpts/instructblip-vicuna-7b'  # 原始
...
# sampler_model_base = 'ckpts/bert-base-uncased'  # 原始
sampler_model_base = '/root/VideoTGB/ckpts/bert-base-uncased'
...
with gr.Blocks(title='LSTP-Chat', theme=gr.themes.Default(), css=block_css) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=7):
            # chatbot = gr.Chatbot(label="LSTP-Chat", bubble_full_width=True).style(height=700)  # 原始
            chatbot = gr.Chatbot(label="LSTP-Chat").style(height=700)  # 原始
            # chatbot = gr.Chatbot(label="LSTP-Chat", type="messages", bubble_full_width=True).scale(1)
            # chatbot = gr.Chatbot(label="LSTP-Chat", bubble_full_width=True).scale(height=700)  
...
# demo.launch(share=False, enable_queue=True, show_api=False)  # 原始
demo.launch(share=True, enable_queue=True, show_api=False)
